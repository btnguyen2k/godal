...
func initDataMysql(sqlc *prom.SqlConnect, table string) {
	...
	sql = fmt.Sprintf("CREATE TABLE %s (id VARCHAR(64), data TEXT, PRIMARY KEY (id)) ENGINE InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci", table)
	if _, err := sqlc.GetDB().Exec(sql); err != nil {
		panic(err)
	}
}
...
func TestGenericDaoMysql_Empty(t *testing.T) {
	name := "TestGenericDaoMysql_Empty"
	dao := initDaoMysql()
...
func TestGenericDaoMysql_GdaoCreateGet(t *testing.T) {
	name := "TestGenericDaoMysql_GdaoCreateGet"
	dao := initDaoMysql()
	bo := &MyBo{
		Id:      "1",
		Name:    "BO - 1",
...
func TestGenericDaoMysql_GdaoCreateTwiceGet_TxModeOff(t *testing.T) {
	name := "TestGenericDaoMysql_GdaoCreateTwiceGet_TxModeOff"
	dao := initDaoMysql()
...
func TestGenericDaoMysql_GdaoCreateTwiceGet_TxModeOn(t *testing.T) {
	name := "TestGenericDaoMysql_GdaoCreateTwiceGet_TxModeOn"
	dao := initDaoMysql()
...
func TestGenericDaoMysql_GdaoCreateMultiThreadsGet_TxModeOff(t *testing.T) {
	name := "TestGenericDaoMysql_GdaoCreateMultiThreadsGet_TxModeOff"
	dao := initDaoMysql()
	dao.SetTransactionMode(false, sql.LevelDefault)
	numThreads := 4
...
func TestGenericDaoMysql_GdaoCreateMultiThreadsGet_TxModeOn(t *testing.T) {
	name := "TestGenericDaoMysql_GdaoCreateMultiThreadsGet_TxModeOn"
	dao := initDaoMysql()
...
func TestGenericDaoMysql_GdaoCreateDelete(t *testing.T) {
	name := "TestGenericDaoMysql_GdaoCreateDelete"
	dao := initDaoMysql()
	bo := &MyBo{
		Id:      "1",
		Name:    "BO - 1",
...
func TestGenericDaoMysql_GdaoCreateDeleteAll(t *testing.T) {
	name := "TestGenericDaoMysql_GdaoCreateDeleteAll"
	dao := initDaoMysql()
	bo := &MyBo{
		Id:      "1",
		Name:    "BO - 1",
...
func TestGenericDaoMysql_GdaoCreateDeleteMany(t *testing.T) {
	name := "TestGenericDaoMysql_GdaoCreateDeleteMany"
	dao := initDaoMysql()
	for i := 1; i <= 3; i++ {
		bo := &MyBo{
			Id:      strconv.Itoa(i),
...
func TestGenericDaoMysql_GdaoFetchAllWithSorting(t *testing.T) {
	name := "TestGenericDaoMysql_GdaoFetchAllWithSorting"
	dao := initDaoMysql()
	numItems := 100
...
func TestGenericDaoMysql_GdaoFetchManyWithPaging(t *testing.T) {
	name := "TestGenericDaoMysql_GdaoFetchManyWithPaging"
	dao := initDaoMysql()
	numItems := 100
...
func TestGenericDaoMysql_GdaoUpdateNotExist(t *testing.T) {
	name := "TestGenericDaoMysql_GdaoUpdateNotExist"
	dao := initDaoMysql()
	bo := &MyBo{
		Id:      "1",
		Name:    "BO - 1",
